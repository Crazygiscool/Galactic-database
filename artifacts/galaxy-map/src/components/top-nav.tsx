...
import { Search, Globe, Film, User, Rocket, Truck, X, ChevronDown } from 'lucide-react';
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', height: 48 }}>
          <div style={{
            ...
            <span style={{ fontSize: 10, color: '#00d4ff', textShadow: '0 0 8px #00d4ff', letterSpacing: '0.16em' }}>
              ◈ IMPERIAL
            </span>
          </div>
          ...
          <div style={{ flex: 1, position: 'relative', display: 'flex', alignItems: 'center', padding: '0 12px' }}>
            <ActiveIcon style={{ width: 13, height: 13, color: C.active, flexShrink: 0, marginRight: 8 }} />
            <select
              value={activeSection}
              ...
              style={{
                ...
                color: C.active, fontFamily: C.font, fontSize: 12,
            ...
            >
              {NAV_ITEMS.map(item => (
                <option key={item.key} value={item.key}
                  style={{ background: '#000c1a', color: '#00d4ff', fontFamily: C.font }}
                >
                  {item.label}
                </option>
              ))}
            </select>
            <ChevronDown style={{ width: 13, height: 13, color: C.inactive, flexShrink: 0, pointerEvents: 'none' }} />
          </div>
        </div>
        ...
        <div style={{
          ...
          <Search style={{ width: 13, height: 13, color: 'rgba(0,212,255,0.5)', flexShrink: 0 }} />
          <input
            type="text"
            value={search}
            ...
            style={{
              ...
              color: '#00d4ff', fontFamily: C.font, fontSize: 11,
